...
import MajorDetailView from '../MajorDetailView/MajorDetailView'
import { Routes, Route } from 'react-router-dom';

// Majors and their descriptions all taken from UTK catalog
const testMajors = [
    {
    ...
    return (
            <div className='appContainerStyle'>
                ...
                <div className='appBodyStyle'>
                    ...
                    {/* Vertical navigation bar with navigation links */}
                    <NavigationBar majors={ majors || testMajors} />

                    {/* Main content to the right */}
                    <div className='content-wrapper'>
                        <Routes>
                            {/* Show any given major's details */}
                            {/* If there are no majors passed, it uses testMajors */}
                            <Route path="majors/:majorName" element={<MajorDetailView majors={majors || testMajors} />} />

                            {/* Main results view */}
                            <Route path="/" element={<MajorsListView majors={majors || testMajors} />} />
                        </Routes>
